...
use UltimoBundle\Entity\Direccion;
...
class DireccionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $direccions = $em->getRepository('UltimoBundle:Direccion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('UltimoBundle\Form\DireccionType', $direccion);
    ...
    {
        $deleteForm = $this->createDeleteForm($direccion);
        $editForm = $this->createForm('UltimoBundle\Form\DireccionType', $direccion);
